<?php
    ...
    class FormTypeErrorConditions {
        public static function getInputFailConditions() {
            return [];
        }

        public static function getFileConditions() {
            return [
        ...
        public static function getEmailConditions() {
            return [
        ...
        public static function getDateConditions() {
            return [
        ...
        public static function getPhoneNumberConditions() {
            return [
